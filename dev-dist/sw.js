...
define(['./workbox-d9a5ed57'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/logos\/(.*)\.(webp|png|svg|ico)$/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/public\/(.*)\.(webp|png|svg|ico)$/, new workbox.CacheFirst({
